...
if __name__ == '__main__':
    ...
    best_model, history = train.train_model(gpt_model, 3000, int(config["eval_interval"]), optimizer, data_loader.get_batch, train_data, val_data, int(config["batch_size"]), int(config["block_size"]), device)
